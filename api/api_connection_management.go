...
/*
ConnectionManagementApiService Create a new connection.
Create a new connection in the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about the new connection.
@return Connection
*/
func (a *ConnectionManagementApiService) CreateConnection(ctx context.Context, body ConnectionDefinition) (Connection, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/connections"
...
/*
ConnectionManagementApiService Delete a connection.
Delete a connection with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the connection to delete.
 * @param type_ Type of connection to delete. Valid values are &#x60;WebhookConnection&#x60;, &#x60;ServiceNowConnection&#x60;.

*/
func (a *ConnectionManagementApiService) DeleteConnection(ctx context.Context, id string, type_ string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/connections/{id}"
...
/*
ConnectionManagementApiService Get a connection.
Get a connection with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of connection to return.
 * @param type_ Type of connection to return. Valid values are &#x60;WebhookConnection&#x60;, &#x60;ServiceNowConnection&#x60;.
@return Connection
*/
func (a *ConnectionManagementApiService) GetConnection(ctx context.Context, id string, type_ string) (Connection, *http.Response, error) {
	var (
...
/*
ConnectionManagementApiService Get a list of connections.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConnectionManagementApiListConnectionsOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of connections returned in the response. The number of connections returned may be less than the &#x60;limit&#x60;.
...
type ConnectionManagementApiListConnectionsOpts struct {
    Limit optional.Int32
    Token optional.String
}

func (a *ConnectionManagementApiService) ListConnections(ctx context.Context, localVarOptionals *ConnectionManagementApiListConnectionsOpts) (ListConnectionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
ConnectionManagementApiService Test a new connection url.
Test a new connection url is valid and can connect.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about the new connection.
@return TestConnectionResponse
*/
func (a *ConnectionManagementApiService) TestConnection(ctx context.Context, body ConnectionDefinition) (TestConnectionResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/connections/test"
...
/*
ConnectionManagementApiService Update a connection.
Update an existing connection.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information to update about the connection.
 * @param id Identifier of the connection to update.
@return Connection
*/
func (a *ConnectionManagementApiService) UpdateConnection(ctx context.Context, body ConnectionDefinition, id string) (Connection, *http.Response, error) {
	var (
