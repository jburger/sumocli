...
/*
MetricsSearchesManagementApiService Save a metrics search.
 ...
 * @param body The definition of the metrics search.
@return MetricsSearchInstance
*/
func (a *MetricsSearchesManagementApiService) CreateMetricsSearch(ctx context.Context, body SaveMetricsSearchRequest) (MetricsSearchInstance, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/metricsSearches"
...
/*
MetricsSearchesManagementApiService Deletes a metrics search.
Deletes a metrics search from the content library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the metrics search.

*/
func (a *MetricsSearchesManagementApiService) DeleteMetricsSearch(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/metricsSearches/{id}"
...
/*
MetricsSearchesManagementApiService Get a metrics search.
Returns a metrics search with the specified identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the metrics search.
@return MetricsSearchInstance
*/
func (a *MetricsSearchesManagementApiService) GetMetricsSearch(ctx context.Context, id string) (MetricsSearchInstance, *http.Response, error) {
	var (
...
/*
MetricsSearchesManagementApiService Updates a metrics search.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body An updated metrics search definition.
 * @param id Identifier of the metrics search.
@return MetricsSearchInstance
*/
func (a *MetricsSearchesManagementApiService) UpdateMetricsSearch(ctx context.Context, body MetricsSearchV1, id string) (MetricsSearchInstance, *http.Response, error) {
	var (
