 ...
 * @param body Information about the new user.
@return UserModel
*/
func (a *UserManagementApiService) CreateUser(ctx context.Context, body CreateUserDefinition) (UserModel, *http.Response, error) {
	var (
 ...
 * @param optional nil or *UserManagementApiDeleteUserOpts - Optional Parameters:
     * @param "TransferTo" (optional.String) -  Identifier of the user to receive the transfer of content from the deleted user.
...
func (a *UserManagementApiService) DeleteUser(ctx context.Context, id string, localVarOptionals *UserManagementApiDeleteUserOpts) (*http.Response, error) {
	var (
...
/*
UserManagementApiService Disable MFA for user.
Disable multi-factor authentication for given user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Email and Password of the user to disable MFA for.
 * @param id Identifier of the user to disable MFA for.

*/
func (a *UserManagementApiService) DisableMfa(ctx context.Context, body DisableMfaRequest, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/users/{id}/mfa/disable"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserManagementApiService Get a user.
Get a user with the given identifier from the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of user to return.
@return UserModel
*/
func (a *UserManagementApiService) GetUser(ctx context.Context, id string) (UserModel, *http.Response, error) {
	var (
...
/*
UserManagementApiService Get a list of users.
Get a list of all users in the organization. The response is paginated with a default limit of 100 users per page.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UserManagementApiListUsersOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of users returned in the response. The number of users returned may be less than the &#x60;limit&#x60;.
     ...
     * @param "SortBy" (optional.String) -  Sort the list of users by the &#x60;firstName&#x60;, &#x60;lastName&#x60;, or &#x60;email&#x60; field.
     * @param "Email" (optional.String) -  Find user with the given email address.
...
func (a *UserManagementApiService) ListUsers(ctx context.Context, localVarOptionals *UserManagementApiListUsersOpts) (ListUserModelsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
UserManagementApiService Change email address.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body New email address of the user.
 * @param id Identifier of the user to change email address.

*/
func (a *UserManagementApiService) RequestChangeEmail(ctx context.Context, body ChangeEmailRequest, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/users/{id}/email/requestChange"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserManagementApiService Reset password.
Reset a user&#x27;s password.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the user to reset password.

*/
func (a *UserManagementApiService) ResetPassword(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/users/{id}/password/reset"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserManagementApiService Unlock a user.
Unlock another user&#x27;s account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The id of the user that needs to be unlocked.

*/
func (a *UserManagementApiService) UnlockUser(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/users/{id}/unlock"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserManagementApiService Update a user.
Update an existing user in the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information to update about the user.
 * @param id Identifier of the user to update.
@return UserModel
*/
func (a *UserManagementApiService) UpdateUser(ctx context.Context, body UpdateUserDefinition, id string) (UserModel, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
