...
/*
ServiceAllowlistManagementApiService Allowlist CIDRs/IP addresses.
 ...
 * @param body List of all CIDR notations and/or IP addresses to be added to the allowlist of the organization.
@return CidrList
*/
func (a *ServiceAllowlistManagementApiService) AddAllowlistedCidrs(ctx context.Context, body CidrList) (CidrList, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/serviceAllowlist/addresses/add"
...
/*
ServiceAllowlistManagementApiService Remove allowlisted CIDRs/IP addresses.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body List of all CIDR notations and/or IP addresses to be removed from the allowlist of the organization.
@return CidrList
*/
func (a *ServiceAllowlistManagementApiService) DeleteAllowlistedCidrs(ctx context.Context, body CidrList) (CidrList, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceAllowlist/addresses/remove"
...
/*
ServiceAllowlistManagementApiService Disable service allowlisting.
Disable service allowlisting functionality for login/API authentication or content sharing for the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param allowlistType The type of allowlisting to be disabled. It can be one of: &#x60;Login&#x60;, &#x60;Content&#x60;, or &#x60;Both&#x60;.

*/
func (a *ServiceAllowlistManagementApiService) DisableAllowlisting(ctx context.Context, allowlistType string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceAllowlist/disable"
...
/*
ServiceAllowlistManagementApiService Enable service allowlisting.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param allowlistType The type of allowlisting to be enabled. It can be one of: &#x60;Login&#x60;, &#x60;Content&#x60;, or &#x60;Both&#x60;.

*/
func (a *ServiceAllowlistManagementApiService) EnableAllowlisting(ctx context.Context, allowlistType string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceAllowlist/enable"
...
/*
ServiceAllowlistManagementApiService Get the allowlisting status.
...
*/
func (a *ServiceAllowlistManagementApiService) GetAllowlistingStatus(ctx context.Context) (AllowlistingStatus, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceAllowlist/status"
...
/*
ServiceAllowlistManagementApiService List all allowlisted CIDRs/IP addresses.
Get a list of all allowlisted CIDR notations and/or IP addresses for the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return CidrList
*/
func (a *ServiceAllowlistManagementApiService) ListAllowlistedCidrs(ctx context.Context) (CidrList, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceAllowlist/addresses"
