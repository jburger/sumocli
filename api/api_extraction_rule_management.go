...
/*
ExtractionRuleManagementApiService Create a new field extraction rule.
Create a new field extraction rule.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about the new field extraction rule.
@return ExtractionRule
*/
func (a *ExtractionRuleManagementApiService) CreateExtractionRule(ctx context.Context, body ExtractionRuleDefinition) (ExtractionRule, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/extractionRules"
...
/*
ExtractionRuleManagementApiService Delete a field extraction rule.
Delete a field extraction rule with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the field extraction rule to delete.

*/
func (a *ExtractionRuleManagementApiService) DeleteExtractionRule(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/extractionRules/{id}"
...
/*
ExtractionRuleManagementApiService Get a field extraction rule.
Get a field extraction rule with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of field extraction rule to return.
@return ExtractionRule
*/
func (a *ExtractionRuleManagementApiService) GetExtractionRule(ctx context.Context, id string) (ExtractionRule, *http.Response, error) {
	var (
...
/*
ExtractionRuleManagementApiService Get a list of field extraction rules.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ExtractionRuleManagementApiListExtractionRulesOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of field extraction rules returned in the response. The number of field extraction rules returned may be less than the &#x60;limit&#x60;.
...
func (a *ExtractionRuleManagementApiService) ListExtractionRules(ctx context.Context, localVarOptionals *ExtractionRuleManagementApiListExtractionRulesOpts) (ListExtractionRulesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListExtractionRulesResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ExtractionRuleManagementApiService Update a field extraction rule.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information to update about the field extraction rule.
 * @param id Identifier of the field extraction rule to update.
@return ExtractionRule
*/
func (a *ExtractionRuleManagementApiService) UpdateExtractionRule(ctx context.Context, body UpdateExtractionRuleDefinition, id string) (ExtractionRule, *http.Response, error) {
	var (
