...
/*
ScheduledViewManagementApiService Create a new scheduled view.
Creates a new scheduled view in the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about the new scheduled view.
@return ScheduledView
*/
func (a *ScheduledViewManagementApiService) CreateScheduledView(ctx context.Context, body CreateScheduledViewDefinition) (ScheduledView, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/scheduledViews"
...
/*
ScheduledViewManagementApiService Disable a scheduled view.
Disable a scheduled view with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the scheduled view to disable.

*/
func (a *ScheduledViewManagementApiService) DisableScheduledView(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/scheduledViews/{id}/disable"
...
/*
ScheduledViewManagementApiService Get a scheduled view.
Get a scheduled view with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the scheduled view to fetch.
@return ScheduledView
*/
func (a *ScheduledViewManagementApiService) GetScheduledView(ctx context.Context, id string) (ScheduledView, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/scheduledViews/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
ScheduledViewManagementApiService Get a list of scheduled views.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ScheduledViewManagementApiListScheduledViewsOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of scheduled views returned in the response. The number of scheduled views returned may be less than the &#x60;limit&#x60;.
...
type ScheduledViewManagementApiListScheduledViewsOpts struct {
    Limit optional.Int32
    Token optional.String
}

func (a *ScheduledViewManagementApiService) ListScheduledViews(ctx context.Context, localVarOptionals *ScheduledViewManagementApiListScheduledViewsOpts) (ListScheduledViewsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListScheduledViewsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ScheduledViewManagementApiService Pause a scheduled view.
Pause a scheduled view with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the scheduled view to pause.
@return ScheduledView
*/
func (a *ScheduledViewManagementApiService) PauseScheduledView(ctx context.Context, id string) (ScheduledView, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/scheduledViews/{id}/pause"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
ScheduledViewManagementApiService Start a scheduled view.
Start a scheduled view with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the scheduled view to start.
@return ScheduledView
*/
func (a *ScheduledViewManagementApiService) StartScheduledView(ctx context.Context, id string) (ScheduledView, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/scheduledViews/{id}/start"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
ScheduledViewManagementApiService Update a scheduled view.
Update an existing scheduled view.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information to update about the scheduled view.
 * @param id Identifier of the scheduled view to update.
@return ScheduledView
*/
func (a *ScheduledViewManagementApiService) UpdateScheduledView(ctx context.Context, body UpdateScheduledViewDefinition, id string) (ScheduledView, *http.Response, error) {
	var (
