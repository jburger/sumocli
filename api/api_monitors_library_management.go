...
/*
MonitorsLibraryManagementApiService Usage info of monitors.
...
*/
func (a *MonitorsLibraryManagementApiService) GetMonitorUsageInfo(ctx context.Context) (MonitorUsageInfo, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue MonitorUsageInfo
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/usageInfo"
...
/*
MonitorsLibraryManagementApiService Get the path of a monitor or folder.
Get the full path of the monitor or folder in the monitors library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the monitor or folder.
@return Path
*/
func (a *MonitorsLibraryManagementApiService) GetMonitorsFullPath(ctx context.Context, id string) (Path, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/{id}/path"
...
/*
MonitorsLibraryManagementApiService Get the root monitors folder.
Get the root folder in the monitors library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return MonitorsLibraryFolderResponse
*/
func (a *MonitorsLibraryManagementApiService) GetMonitorsLibraryRoot(ctx context.Context) (MonitorsLibraryFolderResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/root"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MonitorsLibraryFolderResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MonitorsLibraryManagementApiService Copy a monitor or folder.
Copy a monitor or folder in the monitors library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Fields include:
...
*/
func (a *MonitorsLibraryManagementApiService) MonitorsCopy(ctx context.Context, body ContentCopyParams, id string) (MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/{id}/copy"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MonitorsLibraryBaseResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MonitorsLibraryManagementApiService Create a monitor or folder. 
Create a monitor or folder in the monitors library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The monitor or folder to create.
 * @param parentId Identifier of the parent folder in which to create the monitor or folder.
@return MonitorsLibraryBaseResponse
*/
func (a *MonitorsLibraryManagementApiService) MonitorsCreate(ctx context.Context, body MonitorsLibraryBase, parentId string) (MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors"
...
/*
MonitorsLibraryManagementApiService Delete a monitor or folder. 
Delete a monitor or folder from the monitors library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the monitor or folder to delete.

*/
func (a *MonitorsLibraryManagementApiService) MonitorsDeleteById(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
MonitorsLibraryManagementApiService Bulk delete a monitor or folder. 
...
*/
func (a *MonitorsLibraryManagementApiService) MonitorsDeleteByIds(ctx context.Context, ids []string) (map[string]MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v map[string]MonitorsLibraryBaseResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MonitorsLibraryManagementApiService Export a monitor or folder.
...
*/
func (a *MonitorsLibraryManagementApiService) MonitorsExportItem(ctx context.Context, id string) (MonitorsLibraryBaseExport, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/{id}/export"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MonitorsLibraryBaseExport
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MonitorsLibraryManagementApiService Read a monitor or folder by its path.
Read a monitor or folder by its path in the monitors library structure.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param path The path of the monitor or folder.
@return MonitorsLibraryBaseResponse
*/
func (a *MonitorsLibraryManagementApiService) MonitorsGetByPath(ctx context.Context, path string) (MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/path"
...
/*
MonitorsLibraryManagementApiService Import a monitor or folder.
Import a monitor or folder.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The monitor or folder to be imported.
 * @param parentId Identifier of the parent folder in which to import the monitor or folder.
@return MonitorsLibraryBaseResponse
*/
func (a *MonitorsLibraryManagementApiService) MonitorsImportItem(ctx context.Context, body MonitorsLibraryBaseExport, parentId string) (MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/{parentId}/import"
...
/*
MonitorsLibraryManagementApiService Move a monitor or folder.
 ...
 * @param parentId Identifier of the parent folder to move the monitor or folder to.
@return MonitorsLibraryBaseResponse
*/
func (a *MonitorsLibraryManagementApiService) MonitorsMove(ctx context.Context, id string, parentId string) (MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/{id}/move"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
MonitorsLibraryManagementApiService Get a monitor or folder.
Get a monitor or folder from the monitors library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the monitor or folder to read.
@return MonitorsLibraryBaseResponse
*/
func (a *MonitorsLibraryManagementApiService) MonitorsReadById(ctx context.Context, id string) (MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
MonitorsLibraryManagementApiService Bulk read a monitor or folder.
Bulk read a monitor or folder by the given identifiers from the monitors library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ids A comma-separated list of identifiers.
@return map[string]MonitorsLibraryBaseResponse
*/
func (a *MonitorsLibraryManagementApiService) MonitorsReadByIds(ctx context.Context, ids []string) (map[string]MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *MonitorsLibraryManagementApiService) MonitorsSearch(ctx context.Context, query string, localVarOptionals *MonitorsLibraryManagementApiMonitorsSearchOpts) ([]MonitorsLibraryItemWithPath, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/monitors/search"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []MonitorsLibraryItemWithPath
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
MonitorsLibraryManagementApiService Update a monitor or folder. 
Update a monitor or folder in the monitors library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The monitor or folder to update. The content version must match its latest version number in the monitors library. If the version does not match it will not be updated.
 * @param id Identifier of the monitor or folder to update.
@return MonitorsLibraryBaseResponse
*/
func (a *MonitorsLibraryManagementApiService) MonitorsUpdateById(ctx context.Context, body MonitorsLibraryBaseUpdate, id string) (MonitorsLibraryBaseResponse, *http.Response, error) {
	var (
