...
/*
PasswordPolicyApiService Get the current password policy.
Get the current password policy.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return PasswordPolicy
*/
func (a *PasswordPolicyApiService) GetPasswordPolicy(ctx context.Context) (PasswordPolicy, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/passwordPolicy"
...
/*
PasswordPolicyApiService Update password policy.
Update the current password policy.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
@return PasswordPolicy
*/
func (a *PasswordPolicyApiService) SetPasswordPolicy(ctx context.Context, body PasswordPolicy) (PasswordPolicy, *http.Response, error) {
	var (
