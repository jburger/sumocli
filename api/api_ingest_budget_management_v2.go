...
/*
IngestBudgetManagementV2ApiService Create a new ingest budget.
...
*/
func (a *IngestBudgetManagementV2ApiService) CreateIngestBudgetV2(ctx context.Context, body IngestBudgetDefinitionV2) (IngestBudgetV2, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v2/ingestBudgets"
...
/*
IngestBudgetManagementV2ApiService Delete an ingest budget.
Delete an ingest budget with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the ingest budget to delete.

*/
func (a *IngestBudgetManagementV2ApiService) DeleteIngestBudgetV2(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/ingestBudgets/{id}"
...
/*
IngestBudgetManagementV2ApiService Get an ingest budget.
Get an ingest budget by the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of ingest budget to return.
@return IngestBudgetV2
*/
func (a *IngestBudgetManagementV2ApiService) GetIngestBudgetV2(ctx context.Context, id string) (IngestBudgetV2, *http.Response, error) {
	var (
...
/*
IngestBudgetManagementV2ApiService Get a list of ingest budgets.
Get a list of all ingest budgets. The response is paginated with a default limit of 100 budgets per page.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *IngestBudgetManagementV2ApiListIngestBudgetsV2Opts - Optional Parameters:
...
type IngestBudgetManagementV2ApiListIngestBudgetsV2Opts struct {
    Limit optional.Int32
    Token optional.String
}

func (a *IngestBudgetManagementV2ApiService) ListIngestBudgetsV2(ctx context.Context, localVarOptionals *IngestBudgetManagementV2ApiListIngestBudgetsV2Opts) (ListIngestBudgetsResponseV2, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListIngestBudgetsResponseV2
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
IngestBudgetManagementV2ApiService Reset usage.
...
*/
func (a *IngestBudgetManagementV2ApiService) ResetUsageV2(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/ingestBudgets/{id}/usage/reset"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
IngestBudgetManagementV2ApiService Update an ingest budget.
...
@return IngestBudgetV2
*/
func (a *IngestBudgetManagementV2ApiService) UpdateIngestBudgetV2(ctx context.Context, body IngestBudgetDefinitionV2, id string) (IngestBudgetV2, *http.Response, error) {
	var (
