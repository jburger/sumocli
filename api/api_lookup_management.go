...
func (a *LookupManagementApiService) CreateTable(ctx context.Context, body LookupTableDefinition) (LookupTable, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/v1/lookupTables"
...
/*
LookupManagementApiService Delete a lookup table.
Delete a lookup table completely.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the lookup table.

*/
func (a *LookupManagementApiService) DeleteTable(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/lookupTables/{id}"
...
/*
LookupManagementApiService Delete a lookup table row.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Lookup table row delete definition.
 * @param id Identifier of the lookup table.

*/
func (a *LookupManagementApiService) DeleteTableRow(ctx context.Context, body RowDeleteDefinition, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/lookupTables/{id}/deleteTableRow"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LookupManagementApiService Get a lookup table.
Get a lookup table for the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the lookup table.
@return LookupTable
*/
func (a *LookupManagementApiService) LookupTableById(ctx context.Context, id string) (LookupTable, *http.Response, error) {
	var (
...
/*
LookupManagementApiService Get the status of an async job.
...
*/
func (a *LookupManagementApiService) RequestJobStatus(ctx context.Context, jobId string) (LookupAsyncJobStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/lookupTables/jobs/{jobId}/status"
...
/*
LookupManagementApiService Empty a lookup table.
Delete all data from a lookup table.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the table to clear.
@return LookupRequestToken
*/
func (a *LookupManagementApiService) TruncateTable(ctx context.Context, id string) (LookupRequestToken, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/lookupTables/{id}/truncate"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LookupManagementApiService Edit a lookup table.
Edit the lookup table data. All the fields are mandatory in the request.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The configuration changes for the lookup table.
 * @param id Identifier of the lookup table.
@return LookupTable
*/
func (a *LookupManagementApiService) UpdateTable(ctx context.Context, body LookupUpdateDefinition, id string) (LookupTable, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
LookupManagementApiService Insert or Update a lookup table row.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Lookup table row update definition.
 * @param id Identifier of the lookup table.

*/
func (a *LookupManagementApiService) UpdateTableRow(ctx context.Context, body RowUpdateDefinition, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/lookupTables/{id}/row"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LookupManagementApiService Upload a CSV file.
Create a request to populate a lookup table with a CSV file.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param file
 * @param id Identifier of the lookup table to populate.
 * @param optional nil or *LookupManagementApiUploadFileOpts - Optional Parameters:
     * @param "Merge" (optional.Bool) -  This indicates whether the file contents will be merged with existing data in the lookup table or not. If this is true then data with the same primary keys will be updated while the rest of the rows will be appended. By default, merge is false. The response includes a request identifier that you need to use in the [Request Status API](#operation/requestStatus) to track the status of the upload request.
     * @param "FileEncoding" (optional.String) -  File encoding of file being uploaded.
@return LookupRequestToken
*/

type LookupManagementApiUploadFileOpts struct {
    Merge optional.Bool
    FileEncoding optional.String
}

func (a *LookupManagementApiService) UploadFile(ctx context.Context, file *os.File, id string, localVarOptionals *LookupManagementApiUploadFileOpts) (LookupRequestToken, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/lookupTables/{id}/upload"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
