...
/*
RoleManagementApiService Create a new role.
Create a new role in the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about the new role.
@return RoleModel
*/
func (a *RoleManagementApiService) CreateRole(ctx context.Context, body CreateRoleDefinition) (RoleModel, *http.Response, error) {
	var (
...
/*
RoleManagementApiService Delete a role.
Delete a role with the given identifier from the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the role to delete.

*/
func (a *RoleManagementApiService) DeleteRole(ctx context.Context, id string) (*http.Response, error) {
	var (
...
/*
RoleManagementApiService Get a role.
Get a role with the given identifier in the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the role to fetch.
@return RoleModel
*/
func (a *RoleManagementApiService) GetRole(ctx context.Context, id string) (RoleModel, *http.Response, error) {
	var (
...
/*
RoleManagementApiService Get a list of roles.
Get a list of all the roles in the organization. The response is paginated with a default limit of 100 roles per page.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *RoleManagementApiListRolesOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of roles returned in the response. The number of roles returned may be less than the &#x60;limit&#x60;.
     ...
     * @param "SortBy" (optional.String) -  Sort the list of roles by the &#x60;name&#x60; field.
     * @param "Name" (optional.String) -  Only return roles matching the given name.
@return ListRoleModelsResponse
*/

type RoleManagementApiListRolesOpts struct {
...
func (a *RoleManagementApiService) ListRoles(ctx context.Context, localVarOptionals *RoleManagementApiListRolesOpts) (ListRoleModelsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
RoleManagementApiService Remove role from a user.
...
*/
func (a *RoleManagementApiService) RemoveRoleFromUser(ctx context.Context, roleId string, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
RoleManagementApiService Update a role.
Update an existing role in the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information to update about the role.
 * @param id Identifier of the role to update.
@return RoleModel
*/
func (a *RoleManagementApiService) UpdateRole(ctx context.Context, body UpdateRoleDefinition, id string) (RoleModel, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
