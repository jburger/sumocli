...
/*
LogSearchesEstimatedUsageApiService Gets estimated usage details.
 ...
 * @param body The definition of the log search estimated usage.
@return LogSearchEstimatedUsageDefinition
*/
func (a *LogSearchesEstimatedUsageApiService) GetLogSearchEstimatedUsage(ctx context.Context, body LogSearchEstimatedUsageRequest) (LogSearchEstimatedUsageDefinition, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/logSearches/estimatedUsage"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LogSearchEstimatedUsageDefinition
