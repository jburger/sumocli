...
/*
PartitionManagementApiService Cancel a retention update for a partition
...
*/
func (a *PartitionManagementApiService) CancelRetentionUpdate(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/partitions/{id}/cancelRetentionUpdate"
...
/*
PartitionManagementApiService Create a new partition.
Create a new partition.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about the new partition.
@return Partition
*/
func (a *PartitionManagementApiService) CreatePartition(ctx context.Context, body CreatePartitionDefinition) (Partition, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/partitions"
...
/*
PartitionManagementApiService Decommission a partition.
...
*/
func (a *PartitionManagementApiService) DecommissionPartition(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/partitions/{id}/decommission"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
PartitionManagementApiService Get a partition.
Get a partition with the given identifier from the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of partition to return.
@return Partition
*/
func (a *PartitionManagementApiService) GetPartition(ctx context.Context, id string) (Partition, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/partitions/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
PartitionManagementApiService Get a list of partitions.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PartitionManagementApiListPartitionsOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of partitions returned in the response. The number of partitions returned may be less than the &#x60;limit&#x60;.
...
type PartitionManagementApiListPartitionsOpts struct {
    Limit optional.Int32
    Token optional.String
}

func (a *PartitionManagementApiService) ListPartitions(ctx context.Context, localVarOptionals *PartitionManagementApiListPartitionsOpts) (ListPartitionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
PartitionManagementApiService Update a partition.
Update an existing partition in the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information to update about the partition.
 * @param id Identifier of the partition to update.
@return Partition
*/
func (a *PartitionManagementApiService) UpdatePartition(ctx context.Context, body UpdatePartitionDefinition, id string) (Partition, *http.Response, error) {
	var (
