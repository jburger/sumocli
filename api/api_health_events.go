...
/*
HealthEventsApiService Get a list of health events.
Get a list of all the unresolved health events in your account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *HealthEventsApiListAllHealthEventsOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of health events returned in the response. The number of health events returned may be less than the &#x60;limit&#x60;.
...
func (a *HealthEventsApiService) ListAllHealthEvents(ctx context.Context, localVarOptionals *HealthEventsApiListAllHealthEventsOpts) (ListHealthEventResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/healthEvents"
...
/*
HealthEventsApiService Health events for specific resources.
Get a list of all the unresolved events in your account that belong to the supplied resource identifiers.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Resource identifiers to request health events from.
 * @param optional nil or *HealthEventsApiListAllHealthEventsForResourcesOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of health events returned in the response. The number of health events returned may be less than the &#x60;limit&#x60;.
     * @param "Token" (optional.String) -  Continuation token to get the next page of results. A page object with the next continuation token is returned in the response body. Subsequent GET requests should specify the continuation token to get the next page of results. &#x60;token&#x60; is set to null when no more pages are left.
@return ListHealthEventResponse
*/

type HealthEventsApiListAllHealthEventsForResourcesOpts struct {
    Limit optional.Int32
    Token optional.String
}

func (a *HealthEventsApiService) ListAllHealthEventsForResources(ctx context.Context, body ResourceIdentities, localVarOptionals *HealthEventsApiListAllHealthEventsForResourcesOpts) (ListHealthEventResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/healthEvents/resources"
