...
/*
TransformationRuleManagementApiService Create a new transformation rule.
Create a new transformation rule.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The configuration of the transformation rule to create.
@return TransformationRuleResponse
*/
func (a *TransformationRuleManagementApiService) CreateRule(ctx context.Context, body TransformationRuleRequest) (TransformationRuleResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/transformationRules"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v TransformationRuleResponse
...
/*
TransformationRuleManagementApiService Delete a transformation rule.
Delete a transformation rule with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the transformation rule to delete.

*/
func (a *TransformationRuleManagementApiService) DeleteRule(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/transformationRules/{id}"
...
/*
TransformationRuleManagementApiService Get a transformation rule.
Get a transformation rule with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of transformation rule to return.
@return TransformationRuleResponse
*/
func (a *TransformationRuleManagementApiService) GetTransformationRule(ctx context.Context, id string) (TransformationRuleResponse, *http.Response, error) {
	var (
...
/*
TransformationRuleManagementApiService Get a list of transformation rules.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TransformationRuleManagementApiGetTransformationRulesOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of transformation rules returned in the response.
...
type TransformationRuleManagementApiGetTransformationRulesOpts struct {
    Limit optional.Int32
    Token optional.String
}

func (a *TransformationRuleManagementApiService) GetTransformationRules(ctx context.Context, localVarOptionals *TransformationRuleManagementApiGetTransformationRulesOpts) (TransformationRulesResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v TransformationRulesResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
TransformationRuleManagementApiService Update a transformation rule.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information to update about the transformation rule.
 * @param id Identifier of the transformation rule to update.
@return TransformationRuleResponse
*/
func (a *TransformationRuleManagementApiService) UpdateTransformationRule(ctx context.Context, body TransformationRuleRequest, id string) (TransformationRuleResponse, *http.Response, error) {
	var (
