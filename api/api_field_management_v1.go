...
/*
FieldManagementV1ApiService Create a new field.
 ...
 * @param body Name of a field to add. The name is used as the key in the key-value pair.
@return CustomField
*/
func (a *FieldManagementV1ApiService) CreateField(ctx context.Context, body FieldName) (CustomField, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/fields"
...
/*
FieldManagementV1ApiService Delete a custom field.
...
*/
func (a *FieldManagementV1ApiService) DeleteField(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fields/{id}"
...
/*
FieldManagementV1ApiService Disable a custom field.
...
*/
func (a *FieldManagementV1ApiService) DisableField(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fields/{id}/disable"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
FieldManagementV1ApiService Enable custom field with a specified identifier.
...
*/
func (a *FieldManagementV1ApiService) EnableField(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fields/{id}/enable"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
FieldManagementV1ApiService Get a built-in field.
Get the details of a built-in field.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of a built-in field.
@return BuiltinField
*/
func (a *FieldManagementV1ApiService) GetBuiltInField(ctx context.Context, id string) (BuiltinField, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fields/builtin/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
FieldManagementV1ApiService Get a custom field.
Get the details of a custom field.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of a field.
@return CustomField
*/
func (a *FieldManagementV1ApiService) GetCustomField(ctx context.Context, id string) (CustomField, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
FieldManagementV1ApiService Get capacity information.
...
*/
func (a *FieldManagementV1ApiService) GetFieldQuota(ctx context.Context) (FieldQuotaUsage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fields/quota"
...
/*
FieldManagementV1ApiService Get a list of built-in fields.
...
*/
func (a *FieldManagementV1ApiService) ListBuiltInFields(ctx context.Context) (ListBuiltinFieldsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fields/builtin"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListBuiltinFieldsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
FieldManagementV1ApiService Get a list of all custom fields.
Request a list of all the custom fields configured in your account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ListCustomFieldsResponse
*/
func (a *FieldManagementV1ApiService) ListCustomFields(ctx context.Context) (ListCustomFieldsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListCustomFieldsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
FieldManagementV1ApiService Get a list of dropped fields.
...
*/
func (a *FieldManagementV1ApiService) ListDroppedFields(ctx context.Context) (ListDroppedFieldsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/fields/dropped"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListDroppedFieldsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
