...
type ServiceWhitelistManagementApiService service
/*
ServiceWhitelistManagementApiService Whitelist CIDRs/IP addresses.
 ...
 * @param body List of all CIDR notations and/or IP addresses to be added to the whitelist of the organization.
@return CidrList
*/
func (a *ServiceWhitelistManagementApiService) AddWhitelistedCidrs(ctx context.Context, body CidrList) (CidrList, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/serviceWhitelist/addresses/add"
...
/*
ServiceWhitelistManagementApiService Remove whitelisted CIDRs/IP addresses.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body List of all CIDR notations and/or IP addresses to be removed from the whitelist of the organization.
@return CidrList
*/
func (a *ServiceWhitelistManagementApiService) DeleteWhitelistedCidrs(ctx context.Context, body CidrList) (CidrList, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceWhitelist/addresses/remove"
...
/*
ServiceWhitelistManagementApiService Disable service whitelisting.
Disable service whitelisting functionality for login/API authentication or content sharing for the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param whitelistType The type of whitelisting to be disabled. It can be one of: &#x60;Login&#x60;, &#x60;Content&#x60;, or &#x60;Both&#x60;.

*/
func (a *ServiceWhitelistManagementApiService) DisableWhitelisting(ctx context.Context, whitelistType string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceWhitelist/disable"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	localVarQueryParams.Add("whitelistType", parameterToString(whitelistType, ""))
	// to determine the Content-Type header
...
/*
ServiceWhitelistManagementApiService Enable service whitelisting.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param whitelistType The type of whitelisting to be enabled. It can be one of: &#x60;Login&#x60;, &#x60;Content&#x60;, or &#x60;Both&#x60;.

*/
func (a *ServiceWhitelistManagementApiService) EnableWhitelisting(ctx context.Context, whitelistType string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceWhitelist/enable"
...
/*
ServiceWhitelistManagementApiService Get the whitelisting status.
...
*/
func (a *ServiceWhitelistManagementApiService) GetWhitelistingStatus(ctx context.Context) (AllowlistingStatus, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceWhitelist/status"
...
/*
ServiceWhitelistManagementApiService List all whitelisted CIDRs/IP addresses.
Get a list of all whitelisted CIDR notations and/or IP addresses for the organization.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return CidrList
*/
func (a *ServiceWhitelistManagementApiService) ListWhitelistedCidrs(ctx context.Context) (CidrList, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/serviceWhitelist/addresses"
