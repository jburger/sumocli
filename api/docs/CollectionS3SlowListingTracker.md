...
**BucketName** | **string** | The bucket name of the associated Source. | [optional] [default to null]
**FlaggedAfterMinutes** | **string** | The number of minutes elapsed in scanning after which this incident was created. | [optional] [default to null]
