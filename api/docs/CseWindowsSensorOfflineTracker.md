...
**MinutesWithNoHeartbeatBeforeMarkingOffline** | **string** | The number of minutes without heartbeat after which sensor is marked offline. | [optional] [default to null]
