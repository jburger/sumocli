...
/*
AppManagementApiService Get an app by UUID.
...
@return App
*/
func (a *AppManagementApiService) GetApp(ctx context.Context, uuid string) (App, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/apps/{uuid}"
...
/*
AppManagementApiService App install job status.
...
*/
func (a *AppManagementApiService) GetAsyncInstallStatus(ctx context.Context, jobId string) (AsyncJobStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/apps/install/{jobId}/status"
...
/*
AppManagementApiService Install an app by UUID.
...
*/
func (a *AppManagementApiService) InstallApp(ctx context.Context, body AppInstallRequest, uuid string) (BeginAsyncJobResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/apps/{uuid}/install"
	localVarPath = strings.Replace(localVarPath, "{"+"uuid"+"}", fmt.Sprintf("%v", uuid), -1)
...
/*
AppManagementApiService List available apps.
Lists all available apps from the App Catalog.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ListAppsResult
*/
func (a *AppManagementApiService) ListApps(ctx context.Context) (ListAppsResult, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
