...
/*
ArchiveManagementApiService Create an ingestion job.
Create an ingestion job to pull data from your S3 bucket.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The definition of the ingestion job to create.
 * @param sourceId The identifier of the Archive Source for which the job is to be added.
@return ArchiveJob
*/
func (a *ArchiveManagementApiService) CreateArchiveJob(ctx context.Context, body CreateArchiveJobRequest, sourceId string) (ArchiveJob, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/archive/{sourceId}/jobs"
...
/*
ArchiveManagementApiService Delete an ingestion job.
...
*/
func (a *ArchiveManagementApiService) DeleteArchiveJob(ctx context.Context, sourceId string, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/archive/{sourceId}/jobs/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"sourceId"+"}", fmt.Sprintf("%v", sourceId), -1)
...
/*
ArchiveManagementApiService Get ingestion jobs for an Archive Source.
 ...
 * @param optional nil or *ArchiveManagementApiListArchiveJobsBySourceIdOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of jobs returned in the response. The number of jobs returned may be less than the &#x60;limit&#x60;.
...
func (a *ArchiveManagementApiService) ListArchiveJobsBySourceId(ctx context.Context, sourceId string, localVarOptionals *ArchiveManagementApiListArchiveJobsBySourceIdOpts) (ListArchiveJobsResponse, *http.Response, error) {
	var (
...
/*
ArchiveManagementApiService List ingestion jobs for all Archive Sources.
Get a list of all Archive Sources with the count and status of ingestion jobs.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ListArchiveJobsCount
*/
func (a *ArchiveManagementApiService) ListArchiveJobsCountPerSource(ctx context.Context) (ListArchiveJobsCount, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/archive/jobs/count"
