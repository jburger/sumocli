...
/*
AccessKeyManagementApiService Create an access key.
...
@return AccessKey
*/
func (a *AccessKeyManagementApiService) CreateAccessKey(ctx context.Context, body AccessKeyCreateRequest) (AccessKey, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/accessKeys"
...
/*
AccessKeyManagementApiService Delete an access key.
Deletes the access key with the given accessId.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The accessId of the access key to delete.

*/
func (a *AccessKeyManagementApiService) DeleteAccessKey(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/accessKeys/{id}"
...
/*
AccessKeyManagementApiService List all access keys.
List all access keys in your account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AccessKeyManagementApiListAccessKeysOpts - Optional Parameters:
     * @param "Limit" (optional.Int32) -  Limit the number of access keys returned in the response. The number of access keys returned may be less than the &#x60;limit&#x60;.
...
func (a *AccessKeyManagementApiService) ListAccessKeys(ctx context.Context, localVarOptionals *AccessKeyManagementApiListAccessKeysOpts) (PaginatedListAccessKeysResult, *http.Response, error) {
	var (
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PaginatedListAccessKeysResult
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
AccessKeyManagementApiService List personal keys.
List all access keys that belong to your user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ListAccessKeysResult
*/
func (a *AccessKeyManagementApiService) ListPersonalAccessKeys(ctx context.Context) (ListAccessKeysResult, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/accessKeys/personal"
...
/*
AccessKeyManagementApiService Update an access key.
...
*/
func (a *AccessKeyManagementApiService) UpdateAccessKey(ctx context.Context, body AccessKeyUpdateRequest, id string) (AccessKeyPublic, *http.Response, error) {
	var (
