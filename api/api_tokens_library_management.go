...
/*
TokensLibraryManagementApiService Create a token.
Create a token in the token library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about the token to create.
@return TokenBaseResponse
*/
func (a *TokensLibraryManagementApiService) CreateToken(ctx context.Context, body TokenBaseDefinition) (TokenBaseResponse, *http.Response, error) {
	var (
...
/*
TokensLibraryManagementApiService Delete a token.
Delete a token with the given identifier in the token library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the token to delete.

*/
func (a *TokensLibraryManagementApiService) DeleteToken(ctx context.Context, id string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/tokens/{id}"
...
/*
TokensLibraryManagementApiService Get a token.
Get a token with the given identifier in the token library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Identifier of the token to return.
@return TokenBaseResponse
*/
func (a *TokensLibraryManagementApiService) GetToken(ctx context.Context, id string) (TokenBaseResponse, *http.Response, error) {
	var (
...
/*
TokensLibraryManagementApiService Get a list of tokens.
Get a list of all tokens in the token library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ListTokensBaseResponse
*/
func (a *TokensLibraryManagementApiService) ListTokens(ctx context.Context) (ListTokensBaseResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TokensLibraryManagementApiService Update a token.
Update a token with the given identifier in the token library.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The token to update.
 * @param id Identifier of the token to update.
@return TokenBaseResponse
*/
func (a *TokensLibraryManagementApiService) UpdateToken(ctx context.Context, body TokenBaseDefinitionUpdate, id string) (TokenBaseResponse, *http.Response, error) {
	var (
