...
/*
ContentManagementApiService Content copy job status.
 ...
 * @param optional nil or *ContentManagementApiAsyncCopyStatusOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
...
func (a *ContentManagementApiService) AsyncCopyStatus(ctx context.Context, id string, jobId string, localVarOptionals *ContentManagementApiAsyncCopyStatusOpts) (AsyncJobStatus, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v2/content/{id}/copy/{jobId}/status"
...
/*
ContentManagementApiService Start a content copy job.
 ...
 * @param destinationFolder The identifier of the destination folder.
 * @param optional nil or *ContentManagementApiBeginAsyncCopyOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
...
func (a *ContentManagementApiService) BeginAsyncCopy(ctx context.Context, id string, destinationFolder string, localVarOptionals *ContentManagementApiBeginAsyncCopyOpts) (BeginAsyncJobResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{id}/copy"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
ContentManagementApiService Start a content deletion job.
 ...
 * @param optional nil or *ContentManagementApiBeginAsyncDeleteOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
@return BeginAsyncJobResponse
*/
...
func (a *ContentManagementApiService) BeginAsyncDelete(ctx context.Context, id string, localVarOptionals *ContentManagementApiBeginAsyncDeleteOpts) (BeginAsyncJobResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{id}/delete"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
ContentManagementApiService Start a content export job.
 ...
 * @param optional nil or *ContentManagementApiBeginAsyncExportOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
@return BeginAsyncJobResponse
*/
...
func (a *ContentManagementApiService) BeginAsyncExport(ctx context.Context, id string, localVarOptionals *ContentManagementApiBeginAsyncExportOpts) (BeginAsyncJobResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{id}/export"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
ContentManagementApiService Start a content import job.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The content to import.
 ...
 * @param optional nil or *ContentManagementApiBeginAsyncImportOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
     * @param "Overwrite" (optional.Bool) -  Set this to \&quot;true\&quot; to overwrite a content item if the name already exists.
@return BeginAsyncJobResponse
*/
...
func (a *ContentManagementApiService) BeginAsyncImport(ctx context.Context, body ContentSyncDefinition, folderId string, localVarOptionals *ContentManagementApiBeginAsyncImportOpts) (BeginAsyncJobResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/folders/{folderId}/import"
...
/*
ContentManagementApiService Content deletion job status.
 ...
 * @param optional nil or *ContentManagementApiGetAsyncDeleteStatusOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
@return AsyncJobStatus
*/
...
func (a *ContentManagementApiService) GetAsyncDeleteStatus(ctx context.Context, id string, jobId string, localVarOptionals *ContentManagementApiGetAsyncDeleteStatusOpts) (AsyncJobStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{id}/delete/{jobId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jobId"+"}", fmt.Sprintf("%v", jobId), -1)
...
/*
ContentManagementApiService Content export job result.
 ...
 * @param jobId The identifier of the asynchronous job.
 * @param optional nil or *ContentManagementApiGetAsyncExportResultOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
...
func (a *ContentManagementApiService) GetAsyncExportResult(ctx context.Context, contentId string, jobId string, localVarOptionals *ContentManagementApiGetAsyncExportResultOpts) (ContentSyncDefinition, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{contentId}/export/{jobId}/result"
...
/*
ContentManagementApiService Content export job status.
 ...
 * @param optional nil or *ContentManagementApiGetAsyncExportStatusOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
@return AsyncJobStatus
*/
...
func (a *ContentManagementApiService) GetAsyncExportStatus(ctx context.Context, contentId string, jobId string, localVarOptionals *ContentManagementApiGetAsyncExportStatusOpts) (AsyncJobStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{contentId}/export/{jobId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"contentId"+"}", fmt.Sprintf("%v", contentId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jobId"+"}", fmt.Sprintf("%v", jobId), -1)
...
/*
ContentManagementApiService Content import job status.
 ...
 * @param optional nil or *ContentManagementApiGetAsyncImportStatusOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
@return AsyncJobStatus
*/
...
func (a *ContentManagementApiService) GetAsyncImportStatus(ctx context.Context, folderId string, jobId string, localVarOptionals *ContentManagementApiGetAsyncImportStatusOpts) (AsyncJobStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/folders/{folderId}/import/{jobId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"folderId"+"}", fmt.Sprintf("%v", folderId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jobId"+"}", fmt.Sprintf("%v", jobId), -1)
...
/*
ContentManagementApiService Get content item by path.
Get a content item corresponding to the given path.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param path Path of the content item to retrieve.
@return Content
*/
func (a *ContentManagementApiService) GetItemByPath(ctx context.Context, path string) (Content, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/path"
...
/*
ContentManagementApiService Get path of an item.
Get full path of a content item with the given identifier. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contentId Identifier of the content item to get the path.
@return ContentPath
*/
func (a *ContentManagementApiService) GetPathById(ctx context.Context, contentId string) (ContentPath, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{contentId}/path"
	localVarPath = strings.Replace(localVarPath, "{"+"contentId"+"}", fmt.Sprintf("%v", contentId), -1)
...
/*
ContentManagementApiService Move an item.
Moves an item from its current location to another folder. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param destinationFolderId Identifier of the destination folder.
 * @param id Identifier of the item the user wants to move.
 * @param optional nil or *ContentManagementApiMoveItemOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
...
func (a *ContentManagementApiService) MoveItem(ctx context.Context, destinationFolderId string, id string, localVarOptionals *ContentManagementApiMoveItemOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{id}/move"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
