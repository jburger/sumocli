...
/*
ContentPermissionsApiService Add permissions to a content item.
Add permissions to a content item with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body New permissions to add to the content item with the given identifier.
 * @param id The identifier of the content item.
 * @param optional nil or *ContentPermissionsApiAddContentPermissionsOpts - Optional Parameters:
...
type ContentPermissionsApiAddContentPermissionsOpts struct {
    IsAdminMode optional.String
}

func (a *ContentPermissionsApiService) AddContentPermissions(ctx context.Context, body ContentPermissionUpdateRequest, id string, localVarOptionals *ContentPermissionsApiAddContentPermissionsOpts) (ContentPermissionResult, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v2/content/{id}/permissions/add"
...
/*
ContentPermissionsApiService Get permissions of a content item
Returns content permissions of a content item with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The identifier of the content item.
 * @param optional nil or *ContentPermissionsApiGetContentPermissionsOpts - Optional Parameters:
     * @param "ExplicitOnly" (optional.Bool) -  There are two permission types: explicit and implicit. Permissions specifically assigned to the content item are explicit. Permissions derived from a parent content item, like a folder are implicit. To return only explicit permissions set this to true.
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
@return ContentPermissionResult
*/

type ContentPermissionsApiGetContentPermissionsOpts struct {
    ExplicitOnly optional.Bool
    IsAdminMode optional.String
}

func (a *ContentPermissionsApiService) GetContentPermissions(ctx context.Context, id string, localVarOptionals *ContentPermissionsApiGetContentPermissionsOpts) (ContentPermissionResult, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{id}/permissions"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
ContentPermissionsApiService Remove permissions from a content item.
Remove permissions from a content item with the given identifier.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Permissions to remove from a content item with the given identifier.
 * @param id The identifier of the content item.
 * @param optional nil or *ContentPermissionsApiRemoveContentPermissionsOpts - Optional Parameters:
     * @param "IsAdminMode" (optional.String) -  Set this to \&quot;true\&quot; if you want to perform the request as a Content Administrator.
@return ContentPermissionResult
*/

type ContentPermissionsApiRemoveContentPermissionsOpts struct {
    IsAdminMode optional.String
}

func (a *ContentPermissionsApiService) RemoveContentPermissions(ctx context.Context, body ContentPermissionUpdateRequest, id string, localVarOptionals *ContentPermissionsApiRemoveContentPermissionsOpts) (ContentPermissionResult, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v2/content/{id}/permissions/remove"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
