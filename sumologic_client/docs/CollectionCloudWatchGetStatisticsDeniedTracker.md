...
**ErrorCode** | **string** | The error code from AWS for the request made to get metrics. | [optional] [default to null]
**ErrorMessage** | **string** | The error message from AWS for the request made to get metrics. | [optional] [default to null]
